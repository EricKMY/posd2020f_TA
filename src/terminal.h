...
class Terminal {
    ...
    Terminal(string input) {
        ...
        for (std::sregex_iterator i = words_begin; i != words_end; ++i) {
            ...
            if(_stage == 0){
                ...
                if(match_str == "Ellipse" || match_str == "Triangle" || match_str ==  "Rectangle"){
                    ...
                    _feature_stage ++;
                }else if(_feature_stage == 1 && (match_str == "asc" || match_str == "dec")){
        ...
        for(std::vector<string>::iterator str_it = _shape_str_vector.begin(); str_it != _shape_str_vector.end(); str_it++){
                ...
                if(*str_it == "Ellipse"){
                    ...
                    triangleExceptionVector.push_back(new TwoDimensionalVector(param_vector.at(0), param_vector.at(1)));
                    triangleExceptionVector.push_back(new TwoDimensionalVector(param_vector.at(2), param_vector.at(3)));
                    triangleExceptionVector.push_back(new TwoDimensionalVector(param_vector.at(4), param_vector.at(5)));
    ...
    string showResult() {
        ...
        }else if(_order_feature_str == "dec"){
            DecendingCompare decendingCompare(_sort_feature_str);
            sort->standardSort(decendingCompare);
        }
